...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 21861 or testnet: 31861)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 21862 or testnet: 31862)") + "\n" +
        ...
        "\n" + _("SSL options: (see the ReviveCoin Wiki for SSL setup instructions)") + "\n" +
